      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-block px-4 py-2 rounded-full mb-6" style={{ backgroundColor: "#F7EAF0" }}>
            <span className="text-sm font-medium" style={{ color: "#9B6B7A" }}>Procedimentos</span>
          </div>
          ...
          {treatments.map((item, index) => (
            ...
            >
              <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: "#F7EAF0" }}>
                <item.icon className="w-5 h-5" style={{ color: "#9B6B7A" }} />
              </div>
        ...
        <motion.div
          ...
          style={{ backgroundColor: "rgba(155, 107, 122, 0.07)" }}
        >
          <div className="flex items-start gap-3">
            <AlertCircle className="w-6 h-6 flex-shrink-0 mt-0.5" style={{ color: "#9B6B7A" }} />
