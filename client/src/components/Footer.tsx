...
export default function Footer() {
  ...
  return (
    <footer className="text-white py-12" style={{ backgroundColor: "#3D2535" }}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            <div className="flex items-center mb-4">
              <span className="text-xl font-bold text-white">
                Dra.<span style={{ color: "#C49BAA" }}> Viviane Vendramini</span>
              </span>
            </div>
            <p className="text-base leading-relaxed mb-2" style={{ color: "#F7EAF0" }}>
              Especialista em saúde da mulher, oferecendo atendimento humanizado e atualizado para
              todas as fases da vida feminina.
            </p>
            <p className="text-sm leading-relaxed" style={{ color: "rgba(247, 234, 240, 0.7)" }}>
              CRM 134036 • TEGO / FEBRASGO
            </p>
            <p className="text-sm leading-relaxed mt-2" style={{ color: "rgba(247, 234, 240, 0.7)" }}>
            ...
            <a
              ...
              className="text-sm mt-1 inline-block hover:text-white transition-colors"
              style={{ color: "rgba(247, 234, 240, 0.7)" }}
            >
              (11) 99107-6188
            </a>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={{ color: "#F7EAF0" }}>
              ...
              <li><a href="#faq" className="hover:text-white transition-colors">Depoimentos</a></li>
        ...
        <div className="border-t pt-8 text-center" style={{ borderColor: "rgba(247, 234, 240, 0.2)" }}>
          <p className="text-sm flex items-center justify-center gap-2" style={{ color: "#F7EAF0" }}>
            &copy; {currentYear} Dra. Viviane Vendramini. Todos os direitos reservados. Feito com
            <Heart size={14} className="fill-current" style={{ color: "#C49BAA" }} />
          </p>
        </div>
      </div>
    </footer>
