  ...
  return (
    <section id="about" className="py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-block px-4 py-2 rounded-full mb-6" style={{ backgroundColor: "#F7EAF0" }}>
              <span className="text-sm font-medium" style={{ color: "#9B6B7A" }}>Sobre a Especialista</span>
            </div>
            ...
            <p className="text-lg mb-6 font-medium" style={{ color: "#9B6B7A" }}>
              Ginecologia • Reprodução Humana • Ultrassonografia • Sexualidade
            </p>

            <p className="text-lg mb-4 leading-relaxed" style={{ color: "#3C3C3C" }}>
              A <strong>Dra. Viviane Vendramini</strong> é médica especialista em saúde da mulher, com formação
              sólida em ginecologia e obstetrícia e atuação focada no cuidado integral feminino.
            </p>
            ...
            <p className="text-base mb-8 leading-relaxed" style={{ color: "#3C3C3C" }}>
              Hoje, com <strong>mais de 1000 mulheres acompanhadas</strong>, oferece um cuidado personalizado
            ...
            <div className="grid sm:grid-cols-2 gap-3 mt-8">
              {credentials.map((item, index) => (
                <motion.div
                  ...
                  style={{ borderColor: "rgba(155, 107, 122, 0.15)", backgroundColor: "rgba(247, 234, 240, 0.4)" }}
                >
                  <div className="flex-shrink-0 w-9 h-9 rounded-lg flex items-center justify-center" style={{ backgroundColor: "#F7EAF0" }}>
                    <item.icon className="w-4 h-4" style={{ color: "#9B6B7A" }} />
                  </div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 w-56 h-56 rounded-3xl -z-10" style={{ backgroundColor: "rgba(155, 107, 122, 0.1)" }} />
            <div className="absolute -top-6 -left-6 w-40 h-40 rounded-full -z-10" style={{ backgroundColor: "rgba(155, 107, 122, 0.08)" }} />
          </motion.div>
        </div>
        ...
        >
          {[
            ...
            <div key={index} className="text-center">
              <div className="text-2xl md:text-3xl font-bold mb-2" style={{ color: "#2D1A28" }}>{item.value}</div>
        ...
        >
          <blockquote className="text-3xl md:text-4xl font-bold italic max-w-3xl mx-auto mb-8" style={{ color: "#2D1A28" }}>
